...
public static class TradingWorkflowGraph
{
    private static readonly IReadOnlyDictionary<WorkflowNode, IReadOnlySet<WorkflowNode>> Edges =
        new Dictionary<WorkflowNode, IReadOnlySet<WorkflowNode>>
        {
            ...
            [WorkflowNode.Risk] = Set(WorkflowNode.Execution, WorkflowNode.Reflection, WorkflowNode.Failed),
            [WorkflowNode.Execution] = Set(WorkflowNode.Reflection, WorkflowNode.Failed),
            [WorkflowNode.Reflection] = Set(WorkflowNode.Waiting, WorkflowNode.Completed, WorkflowNode.Failed),
