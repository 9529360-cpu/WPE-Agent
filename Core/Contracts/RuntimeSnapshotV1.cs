...
public sealed class RuntimeSnapshotV1
{
    ...
    public RuntimeHistoricalCollectionV1<HistoricalExecutionRealityV1> HistoricalExecutionReality { get; init; } = new(RuntimeCollectionState.Unsupported, [], null, null, "local-agent-sqlite", "Execution reality history is not connected.");
