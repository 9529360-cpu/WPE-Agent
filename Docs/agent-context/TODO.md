...
- [x] Add bounded, idempotent startup backfill for missing Execution/Recovery/Audit observations, including append-only Unknown-to-Confirmed evidence upgrades and state/timeline consistency checks.
