...
Known gaps: target-machine live availability evidence for the official BLS release calendar, production-grade Fundamental evidence, exchange-reported fee attribution, and broader causal post-trade strategy attribution. Legacy Binance-direct execution services are excluded from production compilation and guarded by regression tests.
