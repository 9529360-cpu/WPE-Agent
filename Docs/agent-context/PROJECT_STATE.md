...
Known gaps: target-machine live availability evidence for the official BLS release calendar, production-grade Fundamental evidence, funding/slippage attribution, broader causal post-trade strategy attribution, and fee certification for providers other than Binance Futures Testnet. Legacy Binance-direct execution services are excluded from production compilation and guarded by regression tests.
