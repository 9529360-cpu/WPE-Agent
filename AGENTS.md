...
Product rule: the trading brain is local deterministic only. Remote or online LLM providers are retired product capabilities and must not be reintroduced into trading runtime, settings, UI, risk, execution, recovery, or audit authority.
