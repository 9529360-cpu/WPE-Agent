...
try{$created=[DateTimeOffset]::ParseExact([string]$manifest.createdUtc,'o',[Globalization.CultureInfo]::InvariantCulture,[Globalization.DateTimeStyles]::RoundtripKind)}catch{Stop-Candidate 'manifest.timestamp-invalid'}
