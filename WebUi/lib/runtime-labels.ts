...
const zhCn: Record<string,string> = {
  ...
  Ready:'就绪', ready:'就绪', Error:'错误', error:'错误', Healthy:'健康', Connected:'已连接', Disconnected:'未连接',
  Approved:'已通过', Passed:'已通过', Allowed:'允许', Rejected:'已拒绝', Denied:'已拒绝', Pending:'等待中', Failed:'失败', FailedTerminal:'执行失败', Succeeded:'执行成功', CapabilityUnavailable:'执行条件不可用',
  PROTECTED:'保护中', COMPLETED:'已完成', COMPLETED_PARTIAL:'部分完成', PENDING:'等待中', FAILED:'失败',
  BUY:'买入', SELL:'卖出', Buy:'买入', Sell:'卖出', Long:'多头', Short:'空头', MARKET:'市价', Market:'市价', LIMIT:'限价', Limit:'限价',
...
const zhTw: Record<string,string> = {
  ...
  Ready:'就緒', ready:'就緒', Error:'錯誤', error:'錯誤', Healthy:'健康', Connected:'已連線', Disconnected:'未連線',
  Approved:'已通過', Passed:'已通過', Allowed:'允許', Rejected:'已拒絕', Denied:'已拒絕', Pending:'等待中', Failed:'失敗', FailedTerminal:'執行失敗', Succeeded:'執行成功', CapabilityUnavailable:'執行條件不可用',
  PROTECTED:'保護中', COMPLETED:'已完成', COMPLETED_PARTIAL:'部分完成', PENDING:'等待中', FAILED:'失敗',
  BUY:'買入', SELL:'賣出', Buy:'買入', Sell:'賣出', Long:'多頭', Short:'空頭', MARKET:'市價', Market:'市價', LIMIT:'限價', Limit:'限價',
