...
test('reachable pages use the typed i18n context and contain no mojibake',()=>{
  const files=['app/(dashboard)/page.tsx','app/(dashboard)/agents/page.tsx','app/(dashboard)/settings/page.tsx','app/(dashboard)/orders/page.tsx','app/(dashboard)/backtest/page.tsx','app/(dashboard)/risk/page.tsx','app/(dashboard)/plugins/page.tsx','app/(dashboard)/monitoring/page.tsx']
...
test('converged route tree preserves notification, settings and Agent controls without retired Teacher surface',()=>{
