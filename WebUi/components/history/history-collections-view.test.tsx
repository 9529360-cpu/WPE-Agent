...
test('maps all seven normalized top-level collections to real available rows', () => {
  ...
  for (const value of ['BTCUSDT', 'binance-futures', 'trend-alpha', 'market-research', 'risk-gate', 'mean-reversion-sol', 'exchange-reported-usdt', 'trade#ABCDEF123456', 'Approved', 'Succeeded', 'automatic.succeeded', 'provider-market-v1', 'Confirmed']) assert.match(html, new RegExp(value))
