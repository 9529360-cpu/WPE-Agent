...
public sealed class TeacherPublicEvidenceGatewayV2Tests
{
    ...
    [Fact] public void CredentialedOrUnboundedSourcePolicyIsRejected(){Assert.Throws<ArgumentException>(()=>new TeacherPublicEvidenceGatewayV2([Source() with{AuthenticationClass="api-key"}]));Assert.Throws<ArgumentException>(()=>new TeacherPublicEvidenceGatewayV2([Source() with{MaximumResponseBytes=6_000_000}]));}
