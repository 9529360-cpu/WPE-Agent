...
public partial class LoginWindow:Window
{
    ...
    public LoginWindow(){InitializeComponent();Loaded+=(_,_)=>{var remembered=_accounts.TryRememberedLogin();if(remembered.Success){AuthenticatedUser=remembered.UserName;DialogResult=true;}};I18n.LanguageChanged+=LanguageChanged;}
