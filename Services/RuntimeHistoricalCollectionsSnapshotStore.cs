...
public sealed class RuntimeHistoricalCollectionsSnapshotStore
{
    ...
    public async Task RefreshAsync(CancellationToken ct)
    {
        ...
        var postTradePnlDrift = await _store.ReadPostTradePnlDriftAsync(request, ct);
        lock (_gate) _current = new(orders, equity, backtests, skillCalls, auditEvents, postTradePnlDrift);
    }
}
...
public sealed record RuntimeHistoricalCollectionsSnapshot(
    ...
    HistoricalCollectionPageV1<HistoricalPostTradePnlDriftV1> PostTradePnlDrift)
{
    public static RuntimeHistoricalCollectionsSnapshot Unsupported() => new(
        ...
        Page<HistoricalPostTradePnlDriftV1>(HistoricalCollectionKindV1.PostTradePnlDrift));
