...
public static class ModelOffRoleRuntimeRegistryBuilderV1
{
    ...
    [
        ...
        Capability("macro", [ModelOffRuntimeRoleV1.Research], "yes", true, true, "current", "bounded observation-only ingestion for two allowlisted official BLS series with pinned endpoints, raw-evidence hashes, append-only revisions, optional official release-calendar correlation and degraded last-known-fact retention; no forecast, causal trading claim or target-machine live availability certification"),
        ...
        Capability("fundamental", [ModelOffRuntimeRoleV1.Research], "yes", true, true, "current", "bounded Binance Futures Testnet venue-instrument facts from the official exchangeInfo endpoint, with exact provider/environment/symbol identity, active perpetual status, coherent base/quote/margin assets, onboard time, freshness and canonical evidence hashes; no protocol, issuer, tokenomics, on-chain, valuation or investment conclusion"),
        ...
        Capability("backtest", [ModelOffRuntimeRoleV1.Research], "yes", true, true, "current", "versioned deterministic validation facts bound to the exact canonical symbol, strategy version, UTC freshness, finite bounded metrics, coherent lifecycle state and tamper-evident Strategy source; no live Testnet performance certification or causal claim"),
