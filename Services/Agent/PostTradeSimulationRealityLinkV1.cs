...
public sealed class PostTradeSimulationRealityLinkerV1
{
    ...
    private static PostTradeSimulationRealityLinkV1 Draft(
        ...
        string code)=>new(
            ...
            Side:review.Side,
            StrategyId:review.StrategyId??string.Empty,
            StrategyVersion:review.StrategyVersion,
            ReviewClosedAtUtc:review.ClosedAtUtc.ToUniversalTime(),
            ReviewOutcome:review.Outcome,
            NetPnl:review.NetPnl,
            ReturnPct:review.ReturnPct,
            State:state,
            Code:code,
            CostModelVersion:null,
            SimulationModelVersion:null,
            VenueRuleVersion:null,
            ArtifactSha256:null,
            IntentSha256:null,
            SimulationSourceSha256:null,
            MarketProvenanceSha256:null,
            SimulatedFillSha256:null,
            SimulatedState:null,
            ObservedDriftSha256:null,
            ObservedState:null,
            ComparisonSha256:null,
            StateMatch:null,
            SimulatedFillRatio:null,
            ObservedFillRatio:null,
            FillRatioDelta:null,
            PriceComparable:null,
            PriceDriftBps:null,
            FeeComparable:null,
            FeeDriftBps:null,
            LatencyComparable:null,
            LatencyDriftMs:null,
            TotalComparable:null,
            TotalExecutionDriftBps:null,
            CanonicalBytes:[],
            CanonicalSha256:string.Empty);
