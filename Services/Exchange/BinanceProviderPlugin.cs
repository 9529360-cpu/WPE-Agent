...
public sealed class BinanceProviderPlugin:IExchangeProviderPlugin
{
    public static ExchangeProviderDescriptor ProviderDescriptor { get; }=new(
        ...
        new HashSet<string>(["account","balance","positions","margin","candles","orderbook","funding","open-interest","index-price","mark-price","instrument-fundamentals","place-order","cancel-order","query-order","order-fees","protection-orders","realtime","health"]));
