    ...
    private static async Task Run(CancellationToken ct)
    {
        ...
        while(!ct.IsCancellationRequested)
        {
            ...
            try
            {
                ...
                if(NumericalStrategySkill.IsNumerical(proposed)&&numericalResearch.TryGetValue(proposed.Instrument,out var matchedNumericalResearch))research[proposed.Instrument]=matchedNumericalResearch;
