...
public static class AutoTradingAgent
{
    ...
    private static async Task Run(CancellationToken ct)
    {
        ...
        var executionSimulationProducer=new ExecutionTopOfBookSimulationProducerV1(exchange.ProviderId,exchange,realtime,Db);
        var automaticGateway=new TradingAutomaticExecutionGateway(executionGateway,exchange,Db,executionSimulationProducer);
